                                    ...
                                    .map(({id, lastName, firstName, active}) => (
                                        <div key={id} className='employees-item'>
                                            ...
                                            <div className='radio-button'>
                                                <label>
                                                    <input type='radio' value='not-active' onChange={() => removeChecked(id)} checked={active ? false : true} />
                                                    not active
                                                </label>
                                                <label>
                                                    <input type='radio' value='active' onChange={() => addChecked(id)} checked={active ? true : false} /> active
                                                </label>
                                            </div>
                                        </div>
                                    ))}
